...
export interface InterviewSession { id: string; config: InterviewConfig; profile?: CandidateProfile; questions: InterviewQuestion[]; turns: InterviewTurn[]; currentQuestion?: InterviewQuestion; startedAt: number; status: 'active' | 'reviewing' | 'completed'; report?: InterviewReport; aiMode: boolean; reviewStatus?: 'waiting' | 'ai_completed' | 'ai_failed' | 'local_fallback'; reviewError?: string }
